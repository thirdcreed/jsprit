...
//		for(PrioritizedVRAListener l : algorithmListeners){
//			if(l.getListener() instanceof SelectedStrategySuccessListener){
//				((SelectedStrategySuccessListener)l.getListener()).informSelectedStrategy(name, problem, solutions);
//			}
//		}
//	}
}
