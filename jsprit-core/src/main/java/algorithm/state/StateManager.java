...
import problem.solution.route.RouteVisitor;
...
import algorithm.ruin.listener.RuinListeners;
...
public class StateManager implements StateGetter, IterationStartsListener, RuinListener, InsertionStartsListener, JobInsertedListener, InsertionEndsListener {
	...
	public void updateLoadStates() {
		...
		addActivityVisitor(new UpdateFuturePickups(this));
		addActivityVisitor(new UpdateOccuredDeliveries(this));
	}

	public void updateTimeWindowStates() {
		addActivityVisitor(new TimeWindowUpdater(this, vrp.getTransportCosts()));
	}
}
